...
<?php
        $sql = "SELECT * FROM categorias, productos WHERE categorias.IDCategoria = '00002' AND productos.IDProducto = '00003'";
...
<?php include ("../php/headerproductos.php") ?>
    ...
    <main>
        ...
        <section class="producto">
            ...
            <?php
                    $sql = "SELECT * FROM productos WHERE IDCategoria = '00002' AND IDProducto = '00006' ";
                    $resul = mysqli_query($conn, $sql);
                    if (mysqli_num_rows($resul) > 0) {
                        while ($row = mysqli_fetch_array($resul)) {
            ?>
