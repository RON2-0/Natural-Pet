...
<?php
        $sql = "SELECT * FROM categorias, productos WHERE categorias.IDCategoria = '00001' AND productos.IDProducto = '00001'";
...
<body>
    ...
    <main>
        ...
        <section class="producto">
            ...
            <?php
                    $sql = "SELECT * FROM productos WHERE IDCategoria = '00001' AND IDProducto = '00002' ";
                    $resul = mysqli_query($conn, $sql);
                    if (mysqli_num_rows($resul) > 0) {
                        while ($row = mysqli_fetch_array($resul)) {
            ?>
